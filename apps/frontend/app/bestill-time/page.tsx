    ...
    <div className="py-16 md:py-24">
      <div className="container-wide section-padding mx-auto">
        ...
        <div className="mb-8 grid gap-4 sm:grid-cols-2">
          <a
            href={`tel:${phoneTel}`}
            className="block rounded-xl border border-stone/10 bg-sage-light/30 px-5 py-4 transition-colors hover:border-sage/30 hover:bg-sage-light/60"
          >
            <p className="mb-1 font-sans text-xs uppercase tracking-widest text-sage">Ring oss</p>
            <span className="inline-flex items-center gap-2 font-sans text-stone">
              <svg
          ...
          >
            ...
            <span className="font-sans text-base font-normal text-stone">Gå til avbestilling</span>
          </Link>
        </div>
